...
<head>
    ...
    <title>@yield('title', 'Runner Dashboard') - Hasta Travel</title>
...
<body>
    ...
    <aside class="admin-sidebar">
        <nav class="sidebar-menu">
            <!-- Dashboard -->
            <div class="menu-item {{ request()->routeIs('runner.dashboard') ? 'active' : '' }}">
            ...
            <!-- Task List -->
            <div class="menu-item {{ request()->routeIs('runner.tasks') ? 'active' : '' }}">
                <a href="{{ route('runner.tasks') }}">
    ...
    <header class="admin-topbar">
        <div class="topbar-left">
            ...
            <a href="{{ route('runner.dashboard') }}" class="topbar-link {{ request()->routeIs('runner.dashboard') ? 'active' : '' }}">
                <i class="bi bi-graph-up-arrow"></i> Latest
            </a>
            <a href="{{ route('runner.calendar') }}" class="topbar-link {{ request()->routeIs('runner.calendar') ? 'active' : '' }}">
        ...
        <div class="topbar-right">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end notification-dropdown" aria-labelledby="notificationDropdown" style="min-width: 350px; max-height: 400px; overflow-y: auto;">
                    ...
                    <li><hr class="dropdown-divider m-0"></li>
                    <li>
                        <a class="dropdown-item text-center py-2" href="{{ route('runner.notifications') }}">
            ...
            <div class="profile-dropdown">
                <button class="profile-btn" type="button" id="profileDropdown" data-bs-toggle="dropdown">
                    ...
                    <span class="profile-name">{{ Auth::user()->name ?? 'Runner' }}</span>
    ...
    <script>
        ...
        function loadRunnerNotifications() {
            fetch('{{ route("runner.notifications.unread-count") }}')
            ...
            fetch('{{ route("runner.notifications.dropdown-list") }}')
                .then(response => response.json())
                .then(data => {
                        ...
                        if (data.notifications && data.notifications.length > 0) {
                            list.innerHTML = data.notifications.map(notif => `
                                <a class="dropdown-item notification-item ${!notif.is_read ? 'unread' : ''}" 
                                   href="{{ route('runner.notifications') }}" 
