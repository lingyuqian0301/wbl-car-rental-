                        ...
                        <div class="mt-8 pt-6 border-t border-gray-200">
                            ...
                            @if($canAction)
                                ...
                                <form action="{{ route('bookings.cancel', $booking->bookingID) }}" method="POST" class="inline-block"
                                    onsubmit="return confirm('Are you sure you want to cancel? Please ensure cancellation is made at least 12 hours before pickup, otherwise no refund will be issued to your wallet.');"> {{-- Added > here --}}
                                    @csrf
                                    <button type="submit" 
