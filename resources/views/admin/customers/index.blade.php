...
<div class="container-fluid py-2">
    ...
    >
        <x-slot name="actions">
            <a href="{{ route('admin.customers.create') }}" class="btn btn-light text-danger pill-btn">
                <i class="bi bi-plus-circle me-1"></i> Create Customer
            </a>
            <button class="btn btn-outline-light text-white pill-btn" onclick="exportReport()">
                <i class="bi bi-download me-1"></i> Export
            </button>
            <button class="btn btn-outline-light text-white pill-btn" onclick="removeSelected()">
    ...
    <script>
        ...
        function toggleBlacklist(customerId, isBlacklisting) {
            ...
            document.getElementById('blacklistForm').action = `/admin/customers/${customerId}/toggle-blacklist`;
