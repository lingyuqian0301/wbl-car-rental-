...
@section('title', 'Create New Motorcycle')

@section('content')
<div class="container-fluid py-2">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h1 class="h4 mb-0">Create New Motorcycle</h1>
    ...
    <div class="card">
        <div class="card-body">
            <form method="POST" action="{{ route('admin.vehicles.motorcycles.store') }}">
                @csrf
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <label class="form-label">Motor Type <span class="text-danger">*</span></label>
                        <input type="text" name="motor_type" class="form-control" value="{{ old('motor_type') }}" required>
                        @error('motor_type')
                            <div class="text-danger small">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="mt-4">
                    <button type="submit" class="btn btn-danger">
                        <i class="bi bi-check-circle me-1"></i> Create Motorcycle
                    </button>
                    <a href="{{ route('admin.vehicles.motorcycles') }}" class="btn btn-outline-secondary">
                        Cancel
                    </a>
                </div>
            </form>
