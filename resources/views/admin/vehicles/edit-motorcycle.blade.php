...
<div class="container-fluid py-2">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h1 class="h4 mb-0">Edit Motorcycle</h1>
    ...
    <div class="card">
        <div class="card-body">
            <form method="POST" action="{{ route('admin.vehicles.motorcycles.update', $vehicle->vehicleID) }}">
                @csrf
                @method('PUT')
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="motor_type" class="form-control" 
                               value="{{ old('motor_type', $motorcycle->motor_type) }}" required>
                        @error('motor_type')
                            <div class="text-danger small">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="mt-4">
                    <button type="submit" class="btn btn-danger">
                        <i class="bi bi-check-circle me-1"></i> Update Motorcycle
                    </button>
