...
.logo:active {
    ...
    <div class="logo-group">
        ...
        <a href="<?php echo e(route('home')); ?>" class="nav-link home-link">
            Home
        </a>
    </div>
</div>
    ...
    <div class="header-right">
        ...
        <a href="<?php echo e(route('wallet.show')); ?>" class="header-status header-link header-metric">
    <span class="metric-label">Deposit Balance</span>
    <span class="metric-value">RM <?php echo e(number_format($wallet_balance, 2)); ?></span>
</a>

<a href="<?php echo e(route('loyalty.show')); ?>" class="header-status header-link header-metric">
    <span class="metric-label">Stamps</span>
    <span class="metric-value"><?php echo e($stamps); ?> / 5</span>
</a>


            <a href="<?php echo e(route('profile.edit')); ?>" class="header-btn">
...
</header><?php /**PATH C:\xampp\htdocs\wbl-car-rental-\resources\views/components/header.blade.php ENDPATH**/ ?>