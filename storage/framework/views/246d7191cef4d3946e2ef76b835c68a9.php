...
<nav class="booking-stepper" aria-label="Booking Progress">
    <div class="booking-stepper-wrapper">
        <ol class="booking-stepper-list">
            <?php $__currentLoopData = $allSteps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                ...
                <li class="booking-stepper-step booking-stepper-step--<?php echo e($stepStatus); ?>">
                    <span class="booking-stepper-label"><?php echo e($step['label']); ?></span>
                    
                    <div class="booking-stepper-circle" aria-current="<?php echo e($isCurrent ? 'step' : 'false'); ?>">
                        <?php if($isCompleted): ?>
                            <span class="booking-stepper-icon">✓</span>
                        <?php else: ?>
                            <span class="booking-stepper-number"><?php echo e($step['number']); ?></span>
                        <?php endif; ?>
                    </div>
                </li>
...
<?php /**PATH C:\xampp\htdocs\myportfolio\resources\views/components/booking-stepper.blade.php ENDPATH**/ ?>