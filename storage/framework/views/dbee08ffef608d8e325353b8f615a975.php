...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin-page-header','data' => ['title' => 'Cars Management','description' => 'Manage all car vehicles','stats' => [
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Cars Management','description' => 'Manage all car vehicles','stats' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
            ['label' => 'Total Cars', 'value' => $totalCars, 'icon' => 'bi-car-front'],
            ['label' => 'Available', 'value' => $totalAvailable, 'icon' => 'bi-check-circle'],
            ['label' => 'Rented', 'value' => $totalRented, 'icon' => 'bi-calendar-check']
...
<?php endif; ?>
    ...
    <div class="d-flex justify-content-end mb-3">
        <div class="d-flex gap-2">
            <a href="<?php echo e(route('admin.vehicles.cars.create')); ?>" class="btn btn-sm btn-light text-danger">
            ...
            <div class="btn-group">
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="<?php echo e(route('admin.vehicles.cars.export-pdf', request()->query())); ?>">
                        <i class="bi bi-file-pdf me-2"></i> Export PDF
                    </a></li>
                    <li><a class="dropdown-item" href="<?php echo e(route('admin.vehicles.cars.export-excel', request()->query())); ?>">
    ...
    <div class="card mb-3">
        <div class="card-body">
            <form method="GET" action="<?php echo e(route('admin.vehicles.cars')); ?>" class="row g-3">
                <!-- Search -->
                <div class="col-md-3">
                ...
                <div class="col-md-12">
                    ...
                    <a href="<?php echo e(route('admin.vehicles.cars')); ?>" class="btn btn-sm btn-outline-secondary">
    ...
    <div class="card">
        <div class="card-header bg-danger text-white d-flex justify-content-between align-items-center">
            ...
            <span class="badge bg-light text-dark"><?php echo e($cars->total()); ?> total</span>
        </div>
            ...
            <div class="table-responsive">
                <table class="table table-hover mb-0">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $cars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $car): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td>
                                <input type="checkbox" class="car-checkbox" value="<?php echo e($car->vehicleID); ?>">
                            </td>
                            <td><strong>#<?php echo e($car->vehicleID); ?></strong></td>
                            <td><?php echo e($car->vehicle_brand ?? 'N/A'); ?></td>
                            <td><?php echo e($car->vehicle_model ?? 'N/A'); ?></td>
                            <td><?php echo e($car->plate_number ?? 'N/A'); ?></td>
                            <td><?php echo e($car->seating_capacity ?? 'N/A'); ?></td>
                            <td><?php echo e($car->transmission ?? 'N/A'); ?></td>
                            <td><?php echo e($car->car_type ?? 'N/A'); ?></td>
                            <td>RM <?php echo e(number_format($car->rental_price ?? 0, 2)); ?></td>
                            <td>
                                <button type="button" 
                                        class="btn btn-sm status-btn status-<?php echo e($car->availability_status ?? 'unknown'); ?>"
                                        data-vehicle-id="<?php echo e($car->vehicleID); ?>"
                                        data-current-status="<?php echo e($car->availability_status ?? 'unknown'); ?>"
                                        data-bs-toggle="modal" 
                                        data-bs-target="#statusChangeModal"
                                        onclick="openStatusModal(this)">
                                    <?php echo e(ucfirst($car->availability_status ?? 'Unknown')); ?>

                                </button>
                            </td>
                            <td>
                                <div class="d-flex gap-1">
                                    <a href="<?php echo e(route('admin.vehicles.show', $car->vehicleID)); ?>" 
                                       class="btn btn-sm btn-outline-info" title="View Car Details">
                                        <i class="bi bi-eye"></i> View
                                    </a>
                                    <a href="<?php echo e(route('admin.vehicles.cars.edit', $car->vehicleID)); ?>" 
                                       class="btn btn-sm btn-outline-primary" title="Edit Car">
                                        <i class="bi bi-pencil"></i> Edit
                                    </a>
                                    <button onclick="deleteCar(<?php echo e($car->vehicleID); ?>, '<?php echo e($car->plate_number); ?>')" 
...
<script>
    ...
    function deleteSelected() {
        ...
        let deletePromises = selected.map(vehicleId => {
            return fetch(`<?php echo e(url('/admin/vehicles/cars')); ?>/${vehicleId}`, {
                method: 'DELETE',
                headers: {
                    'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
                    'Content-Type': 'application/json',
    ...
    function deleteCar(vehicleId, plateNumber) {
        ...
        fetch(`<?php echo e(url('/admin/vehicles/cars')); ?>/${vehicleId}`, {
            method: 'DELETE',
            headers: {
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
                'Content-Type': 'application/json',
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\myportfolio\resources\views/admin/vehicles/cars.blade.php ENDPATH**/ ?>