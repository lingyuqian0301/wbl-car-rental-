...
<body>
    <div class="container">
        ...
        <div class="invoice-section">
            ...
            <div class="invoice-number">#<?php echo e(str_pad($booking->bookingID, 6, '0', STR_PAD_LEFT)); ?></div>
        </div>
        ...
        <div style="margin-bottom: 15px;">
            ...
            <table class="usage-table">
                <tr>
                    ...
                    <td><?php echo e(\Carbon\Carbon::parse($booking->rental_start_date)->format('d M Y, h:i A')); ?></td>
                    <td style="font-weight: bold;">Pick-up Location:</td>
                    <td><?php echo e($booking->pickup_point ?? 'HASTA HQ Office'); ?></td>
                </tr>
                <tr>
                    <td style="font-weight: bold;">Return Date & Time:</td>
                    <td><?php echo e(\Carbon\Carbon::parse($booking->rental_end_date)->format('d M Y, h:i A')); ?></td>
                    <td style="font-weight: bold;">Return Location:</td>
                    <td><?php echo e($booking->return_point ?? 'HASTA HQ Office'); ?></td>
                </tr>
                <tr>
                    <td style="font-weight: bold;">Duration:</td>
                    <td><?php echo e($booking->duration ?? 1); ?> day(s)</td>
                    <td></td>
                    <td></td>
                </tr>
            </table>
        ...
        <table class="details-table">
            <tr>
                <td>Full Name:</td>
                <td><?php echo e($customer->user->name ?? 'N/A'); ?></td>
            </tr>
            <tr>
                <td>Identity Card / Passport No.:</td>
                <td><?php echo e($identityNo ?? 'N/A'); ?></td>
            </tr>
            <tr>
                <td>Phone Number:</td>
            ...
            <tr>
                <td>Email Address:</td>
                <td><?php echo e($customer->user->email ?? 'N/A'); ?></td>
            </tr>
        </table>
        ...
        <table class="details-table">
            <tr>
                <td>Vehicle:</td>
                <td><?php echo e($vehicle->vehicle_brand ?? ''); ?> <?php echo e($vehicle->vehicle_model ?? ''); ?></td>
            </tr>
            <tr>
                <td>Vehicle Type:</td>
                <td><?php echo e($vehicle->vehicleType ?? 'N/A'); ?></td>
            </tr>
            <tr>
                <td>Plate Number:</td>
                <td><?php echo e($vehicle->plate_number ?? 'N/A'); ?></td>
            </tr>
            <tr>
                <td>Color:</td>
                <td><?php echo e($vehicle->color ?? 'N/A'); ?></td>
            </tr>
            <tr>
                <td>Seating Capacity:</td>
                <td>
                    <?php if($vehicle->car): ?>
                        <?php echo e($vehicle->car->seating_capacity); ?> person(s)
            ...
            <tr>
                ...
                <td>
                    <?php if($vehicle->car): ?>
                        <?php echo e(ucfirst($vehicle->car->transmission)); ?>

                    <?php elseif($vehicle->motorcycle): ?>
                        <?php echo e(ucfirst($vehicle->motorcycle->motor_type)); ?>
        ...
        <table class="pricing-table">
            ...
            <tr>
                ...
                <td><?php echo e(number_format($vehicle->rental_price ?? 0, 2)); ?></td>
            </tr>
            <tr>
                <td>Number of Days</td>
                <td><?php echo e($booking->duration ?? 1); ?></td>
            </tr>
            <tr>
                <td>Total Rental Amount</td>
                <td><?php echo e(number_format($booking->rental_amount ?? 0, 2)); ?></td>
            </tr>
            <tr>
                <td>Security Deposit (Refundable)</td>
                <td><?php echo e(number_format($booking->deposit_amount ?? 50, 2)); ?></td>
            </tr>
            <tr style="font-weight: bold; background: #e5e5e5;">
                <td>Total Payable</td>
                <td><?php echo e(number_format(($booking->rental_amount ?? 0) + ($booking->deposit_amount ?? 50), 2)); ?></td>
            </tr>
        </table>
        ...
        <div class="terms-section">
            ...
            <ol class="terms-list">
                <li>A refundable security deposit of RM <?php echo e(number_format($booking->deposit_amount ?? 50, 2)); ?> is required at the time of pick-up.</li>
            ...
            <table class="signature-table">
                <tr>
                    <td>
                        ...
                        <div class="signature-name"><?php echo e(strtoupper($customer->user->name ?? 'RENTER NAME')); ?></div>
                        <div class="signature-date">Renter Signature & Date: <?php echo e(now()->format('d M Y')); ?></div>
                    </td>
                    <td></td> <td>
                        <div class="signature-line"></div>
                        <div class="signature-name">AUTHORIZED REPRESENTATIVE</div>
                        <div class="signature-date">HASTA Travel Authority & Date: <?php echo e(now()->format('d M Y')); ?></div>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div style="margin-top: 40px; padding-top: 15px; border-top: 1px solid #ccc; text-align: center; font-size: 9px;">
            <p>This is an electronically generated document. Booking Reference: #<?php echo e(str_pad($booking->bookingID, 6, '0', STR_PAD_LEFT)); ?></p>
            <p>For inquiries, please contact HASTA Travel at support@hastatravel.com or call +60 12-345 6789</p>
        </div>
    </div>
</body>
</html><?php /**PATH C:\xampp\htdocs\myportfolio\resources\views/bookings/agreement_pdf.blade.php ENDPATH**/ ?>