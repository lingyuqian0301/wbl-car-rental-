...
<div class="inspection-container">
    ...
    <div class="inspection-card">
        <div style="margin-bottom: 0.5rem;">
            <strong>Pickup Location:</strong> <?php echo e($booking->pickup_point ?? 'Not specified'); ?>

        </div>
        <div>
            <strong>Pickup Date:</strong> <?php echo e(\Carbon\Carbon::parse($booking->rental_start_date)->format('d M Y, h:i A')); ?>
    ...
    <?php if(session('error')): ?>
        <div style="background: #fee2e2; border: 1px solid #ef4444; border-radius: 8px; padding: 1rem; margin-bottom: 1.5rem;">
            <strong style="color: #dc2626;">Error:</strong> <?php echo e(session('error')); ?>

        </div>
    <?php endif; ?>

    <?php if(session('success')): ?>
        <div style="background: #d1fae5; border: 1px solid #10b981; border-radius: 8px; padding: 1rem; margin-bottom: 1.5rem;">
            <strong style="color: #059669;">Success:</strong> <?php echo e(session('success')); ?>

        </div>
    <?php endif; ?>

    <form method="POST" action="<?php echo e(route('pickup.confirm', $booking)); ?>" id="inspectionForm" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
            ...
            <div class="date-fuel-section">
                <div>
                    <div class="form-group" style="margin-bottom: 1.5rem;">
                        ...
                        <input type="datetime-local" name="date_check" class="form-input" value="<?php echo e(date('Y-m-d\TH:i')); ?>">
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\myportfolio\resources\views/bookings/pickup.blade.php ENDPATH**/ ?>