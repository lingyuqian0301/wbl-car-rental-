...
<div class="inspection-container">
    ...
    <form method="POST" action="<?php echo e(route('pickup.confirm', $booking)); ?>" id="inspectionForm" enctype="multipart/form-data">
        ...
        <div class="inspection-card">
            <label class="form-label" style="margin-bottom: 1rem;">Rental Agreement with Signiture</label>
            <div style="display: flex; gap: 1rem;">
                <input type="file" id="signature_upload" name="signature_upload" accept="image/*" style="display: none;">
                <button type="button" class="btn-upload" onclick="document.getElementById('signature_upload').click()">
