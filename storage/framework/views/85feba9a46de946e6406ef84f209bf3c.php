...
<?php $__env->startSection('title', 'Runner Tasks'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin-page-header','data' => ['title' => 'Runner Tasks','description' => 'Manage runner assignments for bookings requiring pickup/return outside HASTA HQ Office','stats' => [
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Runner Tasks','description' => 'Manage runner assignments for bookings requiring pickup/return outside HASTA HQ Office','stats' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
            ['label' => 'Total Bookings', 'value' => $totalBookings, 'icon' => 'bi-calendar-check'],
            ['label' => 'Assigned', 'value' => $assignedCount, 'icon' => 'bi-person-check'],
            ['label' => 'Unassigned', 'value' => $unassignedCount, 'icon' => 'bi-person-x'],
            ['label' => 'Today', 'value' => $today->format('d M Y'), 'icon' => 'bi-calendar-day']
...
<?php endif; ?>
    ...
    <div class="filter-card">
        <form method="GET" action="<?php echo e(route('admin.runner.tasks')); ?>" class="row g-3">
            <!-- Search -->
            <div class="col-md-3">
                <label class="form-label small fw-semibold">Search (Booking ID / Customer Name)</label>
                <input type="text" name="search" class="form-control form-control-sm" 
                       value="<?php echo e($search); ?>" placeholder="Enter booking ID or customer name">
            </div>
            ...
            <div class="col-md-2">
                ...
                <select name="sort" class="form-select form-select-sm">
                    <option value="booking_desc" <?php echo e($sort === 'booking_desc' ? 'selected' : ''); ?>>Booking ID (Desc)</option>
                    <option value="pickup_desc" <?php echo e($sort === 'pickup_desc' ? 'selected' : ''); ?>>Pickup Date (Desc)</option>
                    <option value="pickup_asc" <?php echo e($sort === 'pickup_asc' ? 'selected' : ''); ?>>Pickup Date (Asc)</option>
                </select>
            </div>
            ...
            <div class="col-md-2">
                ...
                <select name="filter_booking_status" class="form-select form-select-sm">
                    ...
                    <option value="done" <?php echo e($filterBookingStatus === 'done' ? 'selected' : ''); ?>>Done</option>
                    <option value="current" <?php echo e($filterBookingStatus === 'current' ? 'selected' : ''); ?>>Current</option>
                    <option value="upcoming" <?php echo e($filterBookingStatus === 'upcoming' ? 'selected' : ''); ?>>Upcoming</option>
                </select>
            </div>
            ...
            <div class="col-md-2">
                ...
                <select name="filter_assigned" class="form-select form-select-sm">
                    <option value="">All</option>
                    <option value="assigned" <?php echo e($filterAssigned === 'assigned' ? 'selected' : ''); ?>>Assigned</option>
                    <option value="unassigned" <?php echo e($filterAssigned === 'unassigned' ? 'selected' : ''); ?>>Unassigned</option>
                </select>
            </div>
            ...
            <div class="col-md-2">
                ...
                <select name="filter_runner" class="form-select form-select-sm">
                    ...
                    <?php $__currentLoopData = $runners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $runner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($runner->userID); ?>" <?php echo e($filterRunner == $runner->userID ? 'selected' : ''); ?>>
            ...
            <div class="col-md-1">
                ...
                <div class="d-flex gap-2">
                    ...
                    <?php if($search || $filterBookingStatus || $filterAssigned || $filterRunner): ?>
                    <a href="<?php echo e(route('admin.runner.tasks')); ?>" class="btn btn-outline-secondary btn-sm">
    ...
    <div class="runner-task-table">
        <div class="table-header">
            <i class="bi bi-truck"></i> Runner Tasks (<?php echo e($bookings->total()); ?>)
        </div>
            ...
            <table class="table table-hover mb-0">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $bookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <tr>
                            <td>
                                <a href="<?php echo e(route('admin.bookings.reservations.show', ['booking' => $booking->bookingID])); ?>" 
                            ...
                            <td>
                                <div class="reservation-info-text">
                                    <?php if($pickupDateTime): ?>
                                        <div><strong>Date:</strong> <?php echo e($pickupDateTime->format('d M Y')); ?></div>
                                        <div><strong>Time:</strong> <?php echo e($pickupDateTime->format('H:i')); ?></div>
                                        <div><strong>Location:</strong> <?php echo e($isPickupAtOffice ? '-' : ($pickupLocation ?? 'N/A')); ?></div>
                                    <?php else: ?>
                                        <div>N/A</div>
                                    <?php endif; ?>
                                </div>
                            ...
                            <td>
                                <div class="reservation-info-text">
                                    <?php if($returnDateTime): ?>
                                        <div><strong>Date:</strong> <?php echo e($returnDateTime->format('d M Y')); ?></div>
                                        <div><strong>Time:</strong> <?php echo e($returnDateTime->format('H:i')); ?></div>
                                        <div><strong>Location:</strong> <?php echo e($isReturnAtOffice ? '-' : ($returnLocation ?? 'N/A')); ?></div>
                                    <?php else: ?>
                                        <div>N/A</div>
                                    <?php endif; ?>
                                </div>
                            ...
                            <td>
                                <span class="badge <?php echo e($assignedStatus === 'assigned' ? 'bg-success' : 'bg-warning text-dark'); ?>">
                                    <?php echo e(ucfirst($assignedStatus)); ?>
                            ...
                            <td>
                                <select class="form-select form-select-sm runner-select" 
                                        ...
                                        data-current-runner="<?php echo e($booking->staff_served); ?>">
                                    <option value="">Unassigned</option>
                                    <?php $__currentLoopData = $runners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $runnerOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($runnerOption->userID); ?>" <?php echo e($booking->staff_served == $runnerOption->userID ? 'selected' : ''); ?>>
                                            <?php echo e($runnerOption->name); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\myportfolio\resources\views/admin/runner-tasks/index.blade.php ENDPATH**/ ?>