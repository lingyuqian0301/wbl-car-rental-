...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid py-2">
            ...
            <div class="d-flex flex-column flex-md-row align-items-start align-items-md-center justify-content-between gap-3">
                <div>
                    <div class="d-flex align-items-center gap-3">
                        <div>
                            <h1 class="h3 mb-1 fw-bold">Hasta <?php echo e(isset($isStaffIT) && $isStaffIT ? 'Staff IT' : (isset($isStaff) && $isStaff ? 'Staff' : 'Admin')); ?> Dashboard</h1>
                        </div>
                    </div>
        ...
        <!-- Metric cards: Fleet Status, Payment Queue, Task Need Runner, Revenue -->
        <div class="row g-3 mb-4">
            ...
            <div class="col-12 col-md-6 col-xl-3">
                <a href="<?php echo e(route('admin.runner.tasks', ['filter_assigned' => 'unassigned', 'sort' => 'pickup_asc'])); ?>" class="text-decoration-none text-dark">
                    <div class="card metric-card" style="cursor: pointer; transition: transform 0.2s;" onmouseover="this.style.transform='scale(1.02)'" onmouseout="this.style.transform='scale(1)'">
                        <div class="card-body d-flex gap-3 align-items-center">
                            <div class="metric-icon"><i class="bi bi-person-walking"></i></div>
                            <div>
                                <p class="text-muted mb-1">Task Need Runner</p>
                                <h3 class="fw-bold mb-0"><?php echo e($metrics['unassignedRunnerTasks'] ?? 0); ?></h3>
            ...
            <!-- 4. Revenue (Admin only, absent in staffit) -->
            <?php if((!isset($isStaff) || !$isStaff) && (!auth()->check() || !auth()->user()->isStaffIT())): ?>
            <div class="col-12 col-md-6 col-xl-3">
                <a href="<?php echo e(route('admin.reports.rentals', ['date_range' => 'monthly'])); ?>" class="text-decoration-none text-dark">
                    <div class="card metric-card" style="cursor: pointer; transition: transform 0.2s;" onmouseover="this.style.transform='scale(1.02)'" onmouseout="this.style.transform='scale(1)'">
                        <div class="card-body d-flex gap-3 align-items-center">
                            <div class="metric-icon"><i class="bi bi-cash-coin"></i></div>
                            <div>
                                <p class="text-muted mb-1">Revenue (This Month)</p>
                                <h3 class="fw-bold mb-0">RM <?php echo e(number_format($metrics['revenueThisMonth'] ?? 0, 2)); ?></h3>
                                <small class="text-muted-small">All-time RM <?php echo e(number_format($metrics['revenueAllTime'] ?? 0, 2)); ?></small>
                            </div>
                        </div>
                    </div>
                </a>
        ...
        <!-- Sale Trend (Admin only, renamed from Profit Trend) -->
        <?php if((!isset($isStaff) || !$isStaff) && (!auth()->check() || !auth()->user()->isStaffIT())): ?>
        <div class="card mb-4">
            <div class="card-header card-header-red d-flex justify-content-between align-items-center">
                <span class="fw-semibold">Sale Trend (last 3 months)</span>
                <i class="bi bi-graph-up"></i>
            </div>
            <div class="card-body">
                <div class="row row-cols-2 row-cols-md-3 g-3">
                    <?php $__currentLoopData = $monthlyRevenue ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $point): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col">
                            <a href="<?php echo e(route('admin.reports.rentals', ['date_range' => 'custom', 'date_from' => $point['date_from'], 'date_to' => $point['date_to']])); ?>" class="text-decoration-none text-dark">
                                <div class="p-3 border rounded-3 text-center h-100" style="border-color: #fde2e2; cursor: pointer; transition: transform 0.2s;" onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'">
                                    <p class="mb-1 text-muted"><?php echo e($point['label']); ?></p>
                                    <h5 class="mb-2 fw-bold">RM <?php echo e(number_format($point['total'], 2)); ?></h5>
                                    <div class="progress" style="height: 6px;">
                                        <?php
                                            $max = max(1, collect($monthlyRevenue)->max('total'));
                                            $percent = ($point['total'] / $max) * 100;
                                        ?>
                                        <div class="progress-bar progress-bar-red" role="progressbar" style="width: <?php echo e($percent); ?>%;"></div>
                                    </div>
                                </div>
                            </a>
                        </div>
        ...
        <div class="card mb-4">
            <div class="card-header card-header-red d-flex justify-content-between align-items-center">
                ...
                <a href="<?php echo e(route('admin.bookings.cancellation', ['refund_status' => 'false'])); ?>" class="btn btn-light btn-sm pill-btn">
                    View All
                </a>
            </div>
            <div class="card-body">
                <?php if($cancellationRequests->count() > 0): ?>
                    <div class="table-responsive">
                        <table class="table align-middle">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $cancellationRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
        ...
        <div class="card mb-4">
            <div class="card-header card-header-red d-flex justify-content-between align-items-center">
                ...
                <a href="<?php echo e(route('admin.bookings.reservations', ['sort' => 'created_desc'])); ?>" class="btn btn-light btn-sm pill-btn">
                    View All
                </a>
            </div>
            <div class="card-body">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $recentBookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($booking->customer->user->name ?? 'Unknown'); ?></td>
                                        <td><?php echo e($booking->vehicle->plate_number ?? 'N/A'); ?></td>
                                        <td><?php echo e($booking->rental_start_date?->format('d M') ?? 'N/A'); ?> - <?php echo e($booking->rental_end_date?->format('d M Y') ?? 'N/A'); ?></td>
                                        <td>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\myportfolio\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>